...
Label_Dir="/vinai/vuonghn/Research/CV_courses/Dataset/Chair_ADE20K/val/Chair_ADE20K_MASK/"# Annotetion in png format for train images and validation images (assume the name of the images and annotation images are the same (but annotation is always png format))
Image_Dir="/vinai/vuonghn/Research/CV_courses/Dataset/Chair_ADE20K/val/Chair_ADE20K_IMG/"# Test image folder
...
Classes = ["BackGround", "Chair"] #List of classes
