...
sess_mem = tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) 
import numpy as np
import Data_Reader
...
Train_Image_Dir="/vinai/vuonghn/Research/CV_courses/Dataset/Chair_ADE20K/training/Chair_ADE20K_IMG/" # Images and labels for training
Train_Label_Dir="/vinai/vuonghn/Research/CV_courses/Dataset/Chair_ADE20K/training/Chair_ADE20K_MASK"# Annotetion in png format for train images and validation images (assume the name of the images and annotation images are the same (but annotation is always png format))
UseValidationSet=False# do you want to use validation set in training
Valid_Image_Dir="/vinai/vuonghn/Research/CV_courses/Dataset/Chair_ADE20K/training/Chair_ADE20K_IMG/"# Validation images that will be used to evaluate training
Valid_Labels_Dir="/vinai/vuonghn/Research/CV_courses/Dataset/Chair_ADE20K/training/Chair_ADE20K_MASK"#  (the  Labels are in same folder as the training set)
logs_dir= "logs_2class/"# "path to logs directory where trained model and information will be stored"
...
MAX_ITERATION = int(10000010) # Max  number of training iteration
...
#.........................Placeholders for input image and labels...........................................................................................
  ...
  #.........................Build FCN Net...............................................................................................
    Net =  BuildNetVgg16.BUILD_NET_VGG16(vgg16_npy_path="/vinai/vuonghn/Research/CV_courses/Fully-convolutional-neural-network-FCN-for-semantic-segmentation-Tensorflow-implementation/Model_Zoo/vgg16.npy") #Create class for the network
